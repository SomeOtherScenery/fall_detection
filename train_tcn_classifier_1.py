...
from network import TCNClassifier
import numpy as np
import torch
...
def main():
    ...
    for epoch in range(EPOCHS):
        ...
        if epoch == EPOCHS - 1:
            torch.save(best_model.state_dict(), f"./New_models/TCN_classifier_test_split_1_iter_1_{best_epoch}.pth")
            print("best acc: ", best_acc)
            print("best epoch: ", best_epoch)

        with open("New_models/train_tcn_classifier_split_1_iter_1.csv", 'a+', newline='') as f:
            rowIni = list()
